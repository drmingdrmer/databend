...
pub(in crate::sm_v003) struct InternalSeq {
    pub(in crate::sm_v003) seq: u64,
    pub(in crate::sm_v003) tombstone: bool,
}
...
#[cfg(test)]
mod tests {
    use crate::sm_v003::marked::internal_seq::InternalSeq;
