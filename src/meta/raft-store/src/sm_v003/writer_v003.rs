...
/// Write json lines snapshot data to [`SnapshotStoreV003`].
pub struct WriterV003<'a> {
    ...
    snapshot_store: &'a mut SnapshotStoreV003,
}

impl<'a> io::Write for WriterV003<'a> {
...
impl<'a> WriterV003<'a> {
    ...
    pub fn new(snapshot_store: &'a mut SnapshotStoreV003) -> Result<Self, io::Error> {
